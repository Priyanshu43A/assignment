  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const processedData = {
        ...
        ...(isSignup && { fullName: formData.fullName.trim() }),
      };
      ...
      // Simulate successful response
      // const data = { message: "Success" }; // Simulated response
      console.log(data);

      // Log the auth type and processed form data
      console.log("Auth Type:", mode);
      console.log("Form Data:", processedData);
      console.log("Base URL:", BASE_URL);

      // Show success message
      toast.success(
        isSignup ? "Account created successfully!" : "Successfully logged in!"
      );
        ...
        <div className="hidden rounded-2xl lg:flex flex-1 bg-gradient-to-br from-blue-600 to-purple-700 items-center justify-center p-12">
          <div className="text-start text-white max-w-lg">
            ...
            <p className="text-xl text-blue-100 mb-12">
              {isSignup
                ? "Sign up to access your seller dashboard and do stuff."
                : "Sign in to continue managing your orders and boost your selling account."}
            </p>
